...
validation_parser = IntegerParser()\
    .not_null(default_value=100)\
    .max_value(1000)\
    .min_value(100)  # null check validation and allowed values validation is added
validation_parse_func = validation_parser()  # Yes, you can directly call the object to build the parser

valid_input_data = "565"
